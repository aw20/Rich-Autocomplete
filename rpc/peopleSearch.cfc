<cfcomponent output="false" extends="baseSearch">
	...
	<cffunction name="doSearch">
		<cfquery name="searchResult" datasource="search">
			select searchvalue as label from search1 where searchvalue like <cfqueryparam value="%#this.searchQuery#%" /> limit <cfqueryparam value="#this.itemLimit#" cfsqltype="cf_sql_integer" />;
		</cfquery>
